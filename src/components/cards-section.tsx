    ...
    return(
        <>
            <section className="w-full pb-20" ref={sectionRef}>
                ...
                ref={mockupRef}
                />
                <h2 className="text-7xl font-semibold text-center text-black mb-56" ref={titleRef}>Faça <span className="text-green-title-card" > você </span> mesmo de casa </h2> 
                
                <div className="relative w-full max-w-area-cards h-area-cards mx-auto">
                    <Image src={Card01} ref={card01Ref} className="absolute top-8 left-44 opacity-0"  alt="Card01"/>
                    <Image src={Card02} ref={card02Ref} className="absolute bottom-32 left-0 opacity-0"  alt="Card02"/>
                    <Image src={Card03} ref={card03Ref} className="absolute bottom-0 left-80 opacity-0"  alt="Card03"/>
                    <Image src={Card04} ref={card04Ref} className="absolute top-0 right-32 opacity-0" alt="Card04"/>
                    <Image src={Card05} ref={card05Ref} className="absolute right-0 bottom-28 opacity-0" alt="Card05"/>
                    <Image src={Card06} ref={card06Ref} className="absolute bottom-0 right-80 opacity-0" alt="Card06"/>
                </div>
            </section>
        </>
    )
